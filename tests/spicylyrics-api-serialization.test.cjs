...
test('every SpicyLyrics request uses the configured Linux Firefox user agent', () => {
    const expectedUserAgent = 'Mozilla/5.0 (X11; Linux x86_64; rv:154.0) Gecko/20100101 Firefox/154.0';
